...
export default {
  list: {
    ...
    memberNickname: '会员昵称',
    memberNicknamePlaceholder: '请输入会员昵称',
    withdrawalStatus: '提现状态',
    withdrawalStatusPlaceholder: '请选择提现状态',
    applyTime: '申请时间',
    
    withdrawalAccount: '提现账户',
    accountType: '账户类型',
    applyWithdrawalAmount: '提现金额',
    name: '姓名',
    applyTime: '申请时间',
    withdrawalStatus: '提现状态',
    action: '操作',
    resolve: '处理',
    resolveConfirm: '确定要标记为已处理吗？',
    reject: '拒绝',
  ...
  transactions: {
    ...
    transactionStatusPlaceholder: '请选择状态',
    pending: '处理中',
    success: '成功',
    failed: '失败',
    orderId: '订单号',
