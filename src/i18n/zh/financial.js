 ...
 * @LastEditTime: 2025-04-27 13:42:32
 * @Description: 
 */
export default {
  bills: {
    ...
    relatedGroupName: '群组',
    relatedGroupNamePlaceholder: '请选择群组',
    amount: '金额',
    remark: '备注',
    createTime: '创建时间',
    operator: '操作人',
  ...
  paymentChannels: {
    ...
    edit: '编辑',
    delete: '删除',
    deleteConfirm: '确定要删除该支付渠道吗？',

    addTitle: '新增支付渠道',
    editTitle: '编辑支付渠道',
    channelNamePlaceholder: '请输入支付渠道名称',
    bankNamePlaceholder: '请输入银行名称',
    merchantIdPlaceholder: '请输入商户ID',
    secretKey: '密钥',
